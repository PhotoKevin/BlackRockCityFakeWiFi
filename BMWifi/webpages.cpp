...
"</head>\n"
"\n"
"<body onload=\"myOnload()\" class=\"body\">\n"
" <div class=\"top centerHorizontal\" id=\"top\"></div>\n"
" <div class=\"main centerHorizontal\" id=\"main\">\n"
" <div dir=\"ltr\">\n"
" <p class=\"lic1\">\n"
" <small class=\"lichead1\"><b>Terms and Conditions</b></small>\n"
" </p>\n"
" <div class=\"licbody1\">\n"
" <p>By using our internet service, you hereby assert that you\n"
...
" there are significant security, privacy and confidentiality risks inherent in accessing or transmitting information through the internet, whether the connection is facilitated through wired or wireless technology. Security issues include,\n"
" without limitation, interception of transmissions, loss of data, and the introduction or viruses and other programs that can corrupt or damage your computer.</p>\n"
" <p>Accordingly, you agree that the owner and/or provider of this network is NOT liable for any interception or transmissions, computer worms or viruses, loss of data, file corruption, hacking or damage to your computer or\n"
" other devices that result from the transmission or download of information or materials through the internet service provided.</p>\n"
" <p>Use of the wireless network is subject to the general restrictions outlined below. If abnormal, illegal, or unauthorized behavior is detected, including heavy consumption of bandwidth, the network provider reserves the\n"
" right to permanently disconnect the offending device from the wireless network.</p>\n"
" </div>\n"
" <p class=\"lichead2\"><b>Examples of Illegal Uses</b></p>\n"
" <p class=\"licbody2\">The following are representative examples only and do not comprise a comprehensive list of \n"
" <a href=\"login.html\">illegal</a> uses:</p>\n"
" <ol class=\"liclist2\">\n"
...
" <li>Distribution of pornographic materials to minors; and Child pornography.</li>\n"
" </ol>\n"
" <p class=\"lichead3\"><b>Examples of Unacceptable Uses</b></p>\n"
" <p class=\"licbody3\">The following are representative examples only and do not comprise a comprehensive list of unacceptable uses:</p>\n"
" <ol class=\"liclist3\">\n"
...
" <meta http-equiv=\"refresh\" content=\"1; url=http://login.example.com/legal.html\">\n"
"</head>\n"
"\n"
"<body>\n"
" <p>You should have been sent to http://login.example.com/legal.html by a 302 code. Why weren't you?</p>\n"
"</body>\n"
"\n"
"</html>\n"
;
...
" <tr>\n"
" <td>Unknown: </td>\n"
" <td id=\"unknownCount\"></td>\n"
" </tr>\n"
" <tr>\n"
" <td>Unknown Agent: </td>\n"
" <td id=\"lastUnknownUserAgent\"></td>\n"
" </tr>\n"
"\n"
" <tr>\n"
" <td>&nbsp;</td>\n"
...
" </tr>\n"
" <tr>\n"
" <td><label for=\"ipAddress\">IP:</label> </td>\n"
" <td> <input name=\"ipAddress\" id=\"ipAddress\" required pattern=\"^((\\d|[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])\\.){3}(\\d|[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])$\"> </td>\n"
" <tr>\n"
" <td><label for=\"netmask\">Netmask:</label> </td>\n"
" <td> <input name=\"netmask\" id=\"netmask\" required pattern=\"^((\\d|[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])\\.){3}(\\d|[1-9]\\d|1\\d\\d|2[0-4]\\d|25[0-5])$\"></td>\n"
" </tr>\n"
" <tr>\n"
" <td><label for=\"masterDevice\"> Master Device:</label> </td>\n"
" <td> <input name=\"masterDevice\" id=\"masterDevice\" pattern=\"^([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})$\"> </td>\n"
" </tr>\n"
" <tr>\n"
" <td> Current Device:&nbsp;</td>\n"
" <td> <input id=\"currentDevice\" disabled> </td>\n"
" </tr>\n"
" <tr>\n"
" <td style=\"text\"><input type=\"submit\" value=\"Submit\" class=\"main\"></td>\n"
" <td style=\"text\"><button type=\"button\" onclick=\"setAsMaster()\" class=\"main\">Set as Master</button>\n"
" </tr>\n"
" </table>\n"
" </form>\n"
" <button type=\"button\" onClick=\"location.href='status.html'\" class=\"main\">Status Page</button>\n"
" </div>\n"
"</body\n"
;
...
" <tr>\n"
" <td style=\"text\">\n"
" <input type=\"submit\" value=\"Submit\" class=\"main\" onclick=\"getElementById('submitTimeStamp').value = new Date ().toISOString()\" ></td>\n"
" <input type=\"hidden\" id=\"submitTimeStamp\" name=\"timeStamp\" value=\"3487\">\n"
" </tr>\n"
" </table>\n"
" </form>\n"
